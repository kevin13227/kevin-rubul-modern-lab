        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-12 pt-8 border-t border-gray-600/30">
            <p className="text-base md:text-lg text-gray-300 max-w-4xl mx-auto leading-relaxed opacity-90">
              Our work is published in <a href="https://www.cell.com/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#ff4164] transition-colors underline">Cell</a>, <a href="https://www.pnas.org/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#ff4164] transition-colors underline">PNAS</a>, & <a href="https://www.nature.com/ncomms/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#ff4164] transition-colors underline">Nature communications</a>, among others; and our technology is featured in <a href="https://www.nature.com/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#ff4164] transition-colors underline">Nature</a>, <a href="https://hms.harvard.edu/news" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#ff4164] transition-colors underline">HMS News</a>, etc.
            </p>
          </div>
        </div>
      </div>
